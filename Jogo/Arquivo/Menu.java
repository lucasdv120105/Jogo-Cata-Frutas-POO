...
public class Menu {
    ...
    public static void gerarMapa(Graphics g, int matriz, int tamanhoImagem) {
        ...
        ImageIcon abacateiroIcon = new ImageIcon(Menu.class.getResource("/resources/abacateiro.png"));
        ImageIcon acerolaIcon = new ImageIcon(Menu.class.getResource("/resources/acerola.png"));
        ImageIcon aceroleiroIcon = new ImageIcon(Menu.class.getResource("/resources/aceroleiro.png"));
        ImageIcon amoraIcon = new ImageIcon(Menu.class.getResource("/resources/amora.png"));
        ImageIcon amoreiroIcon = new ImageIcon(Menu.class.getResource("/resources/amoreiro.png"));
        ...
        ImageIcon steveIcon = new ImageIcon(Menu.class.getResource("/resources/steve.png"));
        ...
        for (int i = 0; i < (Menu.arquivoHandler.getAmoreiro()); i++) {
        ...
        for (int i = 0; i < (Menu.arquivoHandler.getAceroleiro()); i++) {
